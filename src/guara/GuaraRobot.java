...
public class GuaraRobot extends Robot {
	...
	public GuaraRobot() {
		...
		UniversalJoint abdHip0 = new UniversalJoint("abdHip0X", "abdHip0Y", new Vector3D(lBodyX / 2, lBodyY / 2, 0.0),
				this, Axis.X, Axis.Y);
		...
		UniversalJoint abdHip1 = new UniversalJoint("abdHip1X", "abdHip1Y", new Vector3D(-lRobot / 2, wRobot / 2, 0.0),
				this, Axis.X, Axis.Y);
		...
		UniversalJoint abdHip2 = new UniversalJoint("abdHip2X", "abdHip2Y", new Vector3D(-lRobot / 2, -wRobot / 2, 0.0),
				this, Axis.X, Axis.Y);
		...
		UniversalJoint abdHip3 = new UniversalJoint("abdHip3X", "abdHip3Y", new Vector3D(lRobot / 2, -wRobot / 2, 0.0),
				this, Axis.X, Axis.Y);
