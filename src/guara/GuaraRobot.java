...
public class GuaraRobot extends Robot
{
   ...
   lThighX = 0.04/2, lThighY = 0.06/3, lThighZ = 0.15, mThigh = 5.63, IxxThigh = 0.077, IyyThigh = 0.077, IzzThigh = 0.003;
   public static final double // shank data
   lShankX = 0.04/2, lLegY = 0.06/3, lLegZ = 0.15, mLeg = 3.6, IxxLeg = 0.2, // 0.049,
         IyyLeg = 0.049, IzzLeg = 0.001;
   public static final double // foot data TO VERIFY
   lFootX = 0.08/3, lFootY = 0.06/3, lFootZ = 0.1, // 0.4,
   ...
   private Link Leg()
   {
      ...
      Graphics3DObject linkGraphics = new Graphics3DObject();
      linkGraphics.translate(0, 0, -lLegZ); // shank
      linkGraphics.addCube(lShankX, lLegY, lLegZ, YoAppearance.DarkSlateGrey());
      linkGraphics.translate(0, 0, +lLegZ); // shank
      linkGraphics.rotate(Math.PI / 2, Axis.X);
      linkGraphics.translate(0.0, 0.0, -hMotor / 2);
      linkGraphics.addCylinder(hMotor, rMotor, YoAppearance.RGBColorFrom8BitInts(70, 130, 180));
